...
class ToddlerVisitsChart extends ChartWidget
{
    protected static ?string $heading = 'Statistik Kunjungan Balita';
    ...
    protected function getData(): array
    {
        ...
        for ($i = 5; $i >= 0; $i--) {
            ...
            $count = \App\Models\Toddler::whereYear('created_at', $date->year)
