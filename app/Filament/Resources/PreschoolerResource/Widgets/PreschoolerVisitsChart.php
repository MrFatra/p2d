...
class PreschoolerVisitsChart extends ChartWidget
{
    protected static ?string $heading = 'Statistik Kunjungan Apras';
    ...
    protected function getData(): array
    {
        ...
        for ($i = 5; $i >= 0; $i--) {
            ...
            $count = \App\Models\Preschooler::whereYear('created_at', $date->year)
