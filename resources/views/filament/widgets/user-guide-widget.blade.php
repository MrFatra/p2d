    ...
    <x-filament::section class="border border-blue-500" style="background-color: #dbeafe !important">
        ...
        <div class="flex items-center text-blue-800">
            <div class="text-sm">
                ...
                <a href="{{ Storage::url('guidance/E-Book-SIPOSYANDU-2025.pdf') }}" target="_blank"
                    rel="noopener noreferrer" class="text-blue-600 hover:underline mt-2 flex gap-2 items-center">
