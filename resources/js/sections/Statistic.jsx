                ...
                <div className="container mx-auto flex flex-col gap-5 justify-center items-center">
                    ...
                    <div className="flex gap-x-6 md:gap-x-20 mt-5 md:mt-10 overflow-x-auto no-scrollbar">
                        ...
                        <div className="flex flex-col items-center min-w-[80px]">
                            <img
                                src="images/baby_face.png"
                                alt="Baby Face"
                                className="w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16"
                            />
                            <p className="text-sm md:text-xl lg:text-2xl font-bold mt-2">
                                {statistics?.baby ?? 0}
                            </p>
                        ...
                        <div className="flex flex-col items-center min-w-[80px]">
                            <img
                                src="images/babies_room.png"
                                alt="Balita"
                                className="w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16"
                            />
                            <p className="text-sm md:text-xl lg:text-2xl font-bold mt-2">
                                {statistics?.toddler ?? 0}
                            </p>
                            <p className="text-xs md:text-sm font-semibold text-center">
                                Balita
                            </p>
                        ...
                        <div className="flex flex-col items-center min-w-[80px]">
                            <img
                                ...
                                alt="Lansia"
                                className="w-8 h-8 md:w-12 md:h-12 lg:w-16 lg:h-16 object-cover"
                            />
                            <p className="text-sm md:text-xl lg:text-2xl font-bold mt-2">
                                {statistics?.elderly ?? 0}
                            </p>
                            <p className="text-xs md:text-sm font-semibold text-center">
                                Lansia
                            </p>
