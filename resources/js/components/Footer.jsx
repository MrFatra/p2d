            ...
            <div className="flex flex-col md:flex-row gap-10 md:gap-20">
                <div className="flex flex-col gap-5 flex-1">
                    <div className="flex items-center gap-3">
                        ...
                        />
                        <p className="text-xl md:text-2xl font-bold">SIPOSYANDU</p>
                    </div>
                    <p className="text-xs md:text-sm font-light max-w-md">
                        ...
                        masyarakat. Bersama, kita bangun masa depan yang lebih
                        sehat, cerdas, dan berkualitas demi kesejahteraan
                        generasi mendatang."
                    </p>
                </div>
                ...
                <div className="flex flex-col flex-1 items-center md:items-start">
                    ...
                    <p className="text-xs md:text-sm font-light text-center md:text-left max-w-md">
                        "Berbagi cerita dan konsultasi dengan bidan kami untuk
                        solusi terbaik. Kami siap mendampingi kesehatan Anda dan
                        buah hati."
                    </p>
